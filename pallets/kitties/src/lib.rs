...
pub mod pallet {
	...
	pub enum Event<T: Config> {
		...
		KittyTransferred { who: T::AccountId, receipt: T::AccountId, kitty_id: KittyId},
	}
	...
	impl<T: Config> Pallet<T> {
		...
		#[pallet::call_index(2)]
		#[pallet::weight(T::WeightInfo::do_something())]
		pub fn transfer(origin: OriginFor<T>, receipt: T::AccountId, kitty_id: KittyId) -> DispatchResult {
			...
			KittyOwner::<T>::insert(kitty_id, &receipt);

			Self::deposit_event(Event::KittyTransferred { who, receipt, kitty_id });
